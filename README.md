...
cnnButton = Button(main, text="Run Proposed CNN + BILSTM", command=trainCNNBILSTM)
cnnButton.place(x=730,y=100)
cnnButton.config(font=font1)

dtButton = Button(main, text="Run Extension CNN+BILSTM+BIGRU", command=trainCNNBILSTMBIGRU)
